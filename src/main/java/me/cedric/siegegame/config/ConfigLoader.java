...
public class ConfigLoader implements GameConfig {
    ...
    private static final String SWITCH_COMMAND_COOLDOWN = "switch-command-cooldown";
    ...
    private List<ShopItem> loadShop(ConfigurationSection section, String worldName) {
        ...
        for (String key : section.getKeys(false)) {
            ...
            NBT.modify(item, nbt -> {
             ...
             ShopItem button = new ShopItem((gamePlayer, clickType) -> {
                ...
                if (includesItem) {
                    ...
                    if (includesItemExact)
                        ...
                        toAdd = new ItemStack(item.getType(), amount);

                    PlayerInventory playerInventory = gamePlayer.getBukkitPlayer().getInventory();

                    if (clickType == ClickType.SWAP_OFFHAND) {
                        ItemStack offhandItem = playerInventory.getItemInOffHand();
                        if (offhandItem.getType() == Material.AIR)
                            playerInventory.setItemInOffHand(toAdd);
                        else
    ...
    @Override
    public int getSwitchCommandCooldown() {
        return configYml.getInt(SWITCH_COMMAND_COOLDOWN);
    }
