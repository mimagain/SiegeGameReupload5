...
public class Team {
    ...
    public void addPlayer(GamePlayer player) {
        ...
        Bukkit.getPluginManager().callEvent(new PlayerTeamChangeEvent(player, oldTeam, this));
    }
    ...
    public void removePlayer(GamePlayer player) {
        if (players.remove(player)) {
            ...
            Bukkit.getPluginManager().callEvent(new PlayerTeamChangeEvent(player, oldTeam, null));
        }
    }

    public void reset() {

        for (GamePlayer player : ImmutableSet.copyOf(players)) {
            removePlayer(player);
        }
        players.clear();
